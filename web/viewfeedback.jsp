...
/*            box-shadow:0px 0px 70px white;
    ...
    <body>
        <div class="maindiv">
          ...
          <tr>  <td style="padding-left:20px;"> <a href="deletefeedback.jsp" class="text">Delete feedback </a>
              </td>
...
<div style="background-size: 100%;  background-color:#A88668; 
     background-repeat: no-repeat; width:500px; height:100%; border-radius: 20px; margin-left:150px; margin-top: 55px;">
    <h3 style="text-align:center; padding-top: 20px; color: #FFEBB8">Feedbacks information</h3>
...
%>
    ...
    <div style="margin-top:15px; padding-left: 250px;">
        <table  cellspacing="50" cellpadding="10" align="center">
            <tr>
                <td style="background-color:#A88668; width:150px;height:100px; border-radius: 20px; text-align: center"><a href="adminpage.jsp" class="link">View Users</a></td>
            </tr>
            <tr>
                <td style="background-color:#A88668; width:150px;height:100px; border-radius: 20px; text-align: center"><a href="viewcomplain.jsp" class="link">View Complain</a></td>
            </tr>
             <tr>
                <td style="background-color:#A88668; width:150px;height:100px; border-radius: 20px; text-align: center"><a href="viewdonerreq.jsp" class="link">View Doner Requests </a></td>
            </tr>
        </table>
    </div>
