       ...
       <div class="Parent1">
           <form action="Userfeedback.jsp">
                ...
                <fieldset style="margin-left:-200px; background-color: #D4D7D7;padding-top:30px; padding-bottom: 60px; padding-right:140px; padding-left: 50px;  border: none; border-radius:40px; box-shadow: 20px 20px 20px 20px whitesmoke; margin-top: -30px; ">
                    <p class="signup"><b>Feedback form</b></p>
                    <label class="text" for="email">Enter your Email ID:</label><br>
                    <input class="box" type="text" id="email" name="EID"><br><br>
                    <label class="text" for="password">Full Name</label><br>
                    <input class="box" type="text"  name="fname"><br><br>
                    <label class="text" for="password">Feedback</label><br>
                    <input class="box" type="text" id="password" name="feedback"><br><br>
                     <label class="text" for="password">Contact</label><br>
                    <input class="box" type="text" id="password" name="contact"><br><br>
